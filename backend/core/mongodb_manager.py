...
try:
    ...
    MongoClient = None
    Database = None
    print("⚠️ pymongo not installed. Run: pip install pymongo>=4.6.0")
...
class MongoDBManager:
    ...
    def __init__(self):
        if not hasattr(self, 'initialized'):
            ...
            self._db_name = os.getenv('MONGODB_DATABASE', 'product_recommender')
    ...
    def _setup_connection(self) -> bool:
        ...
        try:
            ...
            print(f"   Collections: {self._database.list_collection_names()}")
...
def init_mongodb():
    ...
    if mongodb_manager.database is not None:
        ...
        print("⚠️ MongoDB not available - will use fallback")
        return False
