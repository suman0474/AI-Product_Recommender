...
class StrategyKeywordStandardizer:
    ...
    def __init__(self):
        ...
        self.collection = self.db['keyword_standardization'] if self.db is not None else None
    ...
    def standardize_keyword(
        ...
        try:
            ...
            if self.collection is not None and result[2] > 0.5:  # Only store if confidence > 0.5
                self._store_mapping(
                    keyword=keyword,
