...
class DocumentService:
    ...
    def strategy_collection(self):
        ...
        if self._strategy_collection is None:
            try:
                ...
                if self._strategy_collection is not None:
    ...
    def standards_collection(self):
        ...
        if self._standards_collection is None:
            try:
                ...
                if self._standards_collection is not None:
    ...
    def upload_strategy_document(
        ...
        if self.strategy_collection is not None:
            try:
    ...
    def get_strategy_documents(
        ...
        """
        if self.strategy_collection is None:
            return []
    ...
    def upload_standards_document(
        ...
        if self.standards_collection is None:
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'status': 'healthy' if self.strategy_collection is not None else 'unavailable',
