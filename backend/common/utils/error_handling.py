...
def with_retry(
    ...
    Delegates to `common.utils.retry_utils.retry_with_backoff` — the canonical
    retry implementation. Kept here for backward compatibility.
    ...
    Usage:
        ...
        def my_function():
            ...
    """
    from common.utils.retry_utils import retry_with_backoff
