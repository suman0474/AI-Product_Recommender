...
try:
    from common.infrastructure.normalization.value_normalizer import normalize_spec_value, is_valid_spec_value, extract_and_validate_spec
except ImportError:
...
class SpecVerifierAgent:
    ...
    def verify_value(self, key: str, value: Any) -> Tuple[bool, str]:
        ...
        if has_technical_pattern:
            # FIX: Removed 15-word limit to allow comprehensive technical specifications
            # Technical specifications can be detailed and include multiple values
            # Example: "Accuracy: ±0.075%; Range: 0-100 bar; Output: 4-20mA HART; Material: 316L SS"
        ...
        # FIX: Removed 8-word limit to allow comprehensive technical specifications
        # Technical values can contain multiple specifications separated by semicolons
        # Example: "Range: 0-100 bar; Accuracy: ±0.1%; Material: 316SS; Output: 4-20mA"
        # Instead of word count, we rely on other heuristics (verbs, instructional words, etc.)
