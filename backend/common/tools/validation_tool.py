...
class ValidationTool:
    ...
    def validate(
        ...
        try:
            ...
            # Uses both tools.standards_enrichment_tool and common.standards_rag_enrichment
            # =================================================================
            ...
            if enable_standards_enrichment:
                try:
                    ...
                    try:
                        from common.agentic.deep_agent.schema.populator_legacy import (
    ...
    def enrich_schema_parallel(
        ...
        try:
            ...
            enricher = ParallelSchemaEnricher(max_workers=5)
            enriched = enricher.enrich_schema(product_type, schema)
