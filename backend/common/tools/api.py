...
def identify_instruments():
    ...
    """
    # DEPRECATED: instrument_tools moved into solution deep agent workflow
    # Use /api/agentic/instrument-identifier endpoint instead
    return api_response(False, error="This endpoint is deprecated. Use /api/agentic/instrument-identifier instead.", status_code=410)
