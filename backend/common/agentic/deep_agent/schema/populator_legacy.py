...
def populate_schema_with_deep_agent(
    ...
    try:
        from common.agentic.deep_agent.schema.generation.deep_agent import (
...
def _fallback_populate(
    ...
    try:
        from common.agentic.deep_agent.specifications.templates.augmented import AugmentedProductTemplates
