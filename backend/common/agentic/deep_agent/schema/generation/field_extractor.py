...
INDUSTRIAL_INSTRUMENT_DEFAULTS = {
    # ==========================================================================
    # PERFORMANCE - Expanded for complete schema coverage
    # ==========================================================================
    ...
    "Hysteresis": "±0.05% of span typical",
    "Resolution": "16-bit digital resolution",
    "Rangeability": "Up to 100:1",
    "Turndown Ratio": "Up to 100:1",
    "Measurement Units": "Engineering units configurable",
    "Measurement Update Rate": "Up to 25 times/second",
    "Data Update Rate": "Up to 25 times/second",
    ...
    "Supply Voltage": "10.5-42.5 VDC or 24 VDC",
    ...
    "Electrical Connection": "Terminal block or M12 connector",
    "Power Consumption": "< 1W typical",
    "Reverse Polarity Protection": "Yes",
    "Galvanic Isolation": "500V DC minimum",
    "EMI Immunity": "EN 61326 Level A",
    "Electrode Impedance Monitoring": "Optional",

    # ==========================================================================
    # MECHANICAL - Expanded
    # ==========================================================================
    "Housing Material": "316L SS, Aluminum, or Fiberglass per NEMA 250",
    "Enclosure Material": "Die-cast aluminum or 316L SS",
    "Process Connection": "1/2\" NPT, 1/2\" BSP, flanged per ISO 1179",
    "Wetted Parts Material": "316L SS, Hastelloy C-276 per NACE MR0175",
    "Wetted Material": "316L SS, Hastelloy C-276 per NACE MR0175",
    "Mounting Options": "Wall, Pole, Panel mount, 2\" pipe mount",
    "Mounting Type": "Direct mount, Remote mount, Panel mount",
    "Mounting Orientation": "Any orientation within specifications",
    "Display Options": "Optional LCD with local configuration",
    "Display Type": "4-digit LCD with backlight option",
    "Probe Length": "Application specific",
    "Process Connection Material": "316L SS standard",
    "Dimensions": "Consult datasheet for specific model",
    "Cable Gland Material": "Nickel-plated brass or 316L SS",
    "Mounting Bracket Material": "316L SS or Carbon Steel",
    "External Fastener Material": "316L SS",
    "Gasket Material": "PTFE, Viton, or Graphite",
    "Flange Material": "316L SS, Carbon Steel per ASME B16.5",
    "Liner Material Options": "PTFE, PFA, Rubber",
    "Electrode Material Options": "316L SS, Hastelloy, Titanium, Tantalum",
    "Sensor Body Material": "316L SS standard",
    ...
    "Process Temperature Limit": "Model dependent",
    "Temperature Range": "Model dependent",
    "Pressure Range": "Model dependent",
    "Ingress Protection": "IP66/IP67 per IEC 60529",
    "IP Rating": "IP66/IP67 per IEC 60529",
    "Protection Rating": "IP66/IP67 per IEC 60529",
    "Hazardous Area Rating": "ATEX II 1/2 G Ex ia/d, IECEx, Class I Div 1/2",
    "Hazardous Location Certification No": "See certification label",
    "Vibration Resistance": "IEC 60068-2-6: 4g, 10-500Hz",
    "Shock Resistance": "IEC 60068-2-27: 30g",
    "Humidity Range": "0-100% RH non-condensing",
    "Operating Altitude": "Up to 2000m without derating",
    "Altitude Limit": "Up to 2000m without derating",
    "Noise Emission Level": "< 70 dBA typical",

    # ==========================================================================
    # COMPLIANCE & CERTIFICATIONS - Expanded
    # ==========================================================================
    "Safety Integrity Level": "SIL 2/3 capable per IEC 61508/61511",
    "SIL Rating": "SIL 2/3 capable per IEC 61508/61511",
    "Certifications": "ATEX, IECEx, cULus, CE, RoHS",
    "Additional Certifications": "ATEX, IECEx, cULus, CE, RoHS",
    "CE Marking": "Yes, per applicable directives",
    "Explosion Proof": "ATEX/IECEx certified options",
    "IEC Ex Rating": "IECEx certified",
    "ATEX Rating": "ATEX II 1/2 G Ex ia/d",
    "Pressure Equipment Directive": "PED 2014/68/EU compliant",
    "REACH Compliance": "Compliant",
    "RoHS Compliance": "Compliant",
    "Potable Water Certification": "NSF/ANSI 61 available",
    "Material Compliance": "NACE MR0175/ISO 15156 available",
    ...
    "Batch Control Functions": "Optional",
    "Totalizer Function": "Optional",
    "Empty Pipe Detection": "Yes",
    "Calibration Interval": "1-5 years recommended",
    "Internal Memory": "Optional trend logging",

    # ==========================================================================
    # INTEGRATION & COMMUNICATION - Expanded
    # ==========================================================================
    "Communication Protocol": "HART 7, FF H1, Profibus PA available",
    "Communication Protocol Version": "HART 7, FF H1, Profibus PA available",
    "Additional Output Signals": "Pulse, Frequency, Status outputs available",
    "Fieldbus Options": "HART, Foundation Fieldbus, Profibus PA, Modbus",

    # ==========================================================================
    # PERFORMANCE EFFECTS - Expanded
    # ==========================================================================
    "Temperature Effect": "±0.05% to ±0.1% per 10°C typical",
    "Temperature Effect On Accuracy": "±0.05% to ±0.1% per 10°C typical",
    "Static Pressure Effect": "±0.05% per 100 bar",
    "Static Pressure Effect On Accuracy": "±0.05% per 100 bar",
    "Power Supply Variation Effect": "< 0.005% per Volt",
    "Power Supply Variation Effect On Accuracy": "< 0.005% per Volt",
    "Vibration Effect": "±0.05% of URL per IEC 60770",

    # ==========================================================================
    # FLOW-SPECIFIC (for flow meters)
    # ==========================================================================
    "Flow Rate Range": "Model dependent",
    "Flow Velocity Range": "0.3 to 10 m/s typical",
    "Minimum Conductivity": "5 µS/cm for mag meters",
    "Bi Directional Measurement": "Yes",
    "Fluid Viscosity": "Model dependent",
    "Fluid Compatibility": "Consult chemical compatibility chart",
    "External Chemical Resistance": "IP66/IP67 enclosure",

    # ==========================================================================
    # LEVEL-SPECIFIC (for level transmitters)
    # ==========================================================================
    "Density Range": "Model dependent",
    "Conductivity Range": "Model dependent",
...
# =============================================================================
# FIELD NAME ALIASES - Maps UI field names to their equivalent default keys
# =============================================================================
FIELD_NAME_ALIASES = {
    # SIL/Safety
    "sil rating": ["safety integrity level", "sil capability", "sil"],
    "safety integrity level": ["sil rating", "sil capability"],
    # Temperature
    "ambient temperature": ["ambient temperature range", "operating temperature"],
    "ambient temperature range": ["ambient temperature", "operating temperature"],
    "temperature range": ["temperature measurement range", "process temperature range"],
    "storage temperature": ["storage temperature range"],
    # Pressure
    "pressure range": ["pressure measurement range", "measurement range"],
    "static pressure effect": ["static pressure effect on accuracy"],
    "static pressure effect on accuracy": ["static pressure effect"],
    # Humidity
    "humidity range": ["humidity", "relative humidity", "operating humidity"],
    # Materials
    "wetted material": ["wetted parts material", "wetted parts"],
    "wetted parts": ["wetted material", "wetted parts material"],
    "housing material": ["enclosure material"],
    "enclosure material": ["housing material"],
    "cable gland material": ["cable entry material"],
    # Power
    "power supply variation effect": ["power supply variation effect on accuracy"],
    "supply voltage": ["power supply", "operating voltage"],
    # Certifications
    "certifications": ["certification", "approvals", "additional certifications"],
    "ce marking": ["ce mark", "ce certified"],
    "explosion proof": ["explosion protection", "hazardous area rating"],
    "iec ex rating": ["iecex rating", "iecex certified"],
    # Electrical
    "electrical connection": ["electrical connections", "connection type"],
    "output signal": ["output", "primary output signal"],
    # Performance
    "response time": ["time response", "settling time"],
    "linearity": ["non linearity", "measurement linearity"],
    "repeatability": ["measurement repeatability"],
    "accuracy": ["measurement accuracy", "accuracy class"],
    # Connection
    "process connection": ["process connections", "connection"],
    # Misc
    "emi immunity": ["emc immunity", "electromagnetic immunity"],
    "galvanic isolation": ["isolation", "electrical isolation"],
    "ip rating": ["ingress protection", "protection rating"],
    "protection rating": ["ip rating", "ingress protection"],
    "measurement update rate": ["data update rate", "update rate"],
}


def _get_field_aliases(field_name_normalized: str) -> List[str]:
    """Get aliases for a field name to try matching."""
    aliases = [field_name_normalized]

    # Check direct aliases
    if field_name_normalized in FIELD_NAME_ALIASES:
        aliases.extend(FIELD_NAME_ALIASES[field_name_normalized])

    # Also check partial matches
    for alias_key, alias_values in FIELD_NAME_ALIASES.items():
        if field_name_normalized in alias_key or alias_key in field_name_normalized:
...
def get_default_value_for_field(product_type: str, field_name: str) -> Optional[str]:
    ...
    # Get all aliases to try for this field
    field_aliases = _get_field_aliases(field_normalized)
    ...
    # Try 1: Exact match (including aliases)
    for alias in field_aliases:
        if alias in defaults_normalized:
            logger.debug(f"[SCHEMA_FIELD] Exact field match: {field_name} (via alias: {alias})")
            return defaults_normalized[alias]

    # Try 2: Contains match (either direction) - check all aliases
    for alias in field_aliases:
        for default_norm, value in defaults_normalized.items():
            if alias in default_norm or default_norm in alias:
                logger.debug(f"[SCHEMA_FIELD] Contains match: '{field_name}' (alias: {alias}) ~ '{default_norm}'")
                return value

    # Try 3: Keyword overlap with relaxed threshold - check all aliases
    best_match = None
    best_score = 0
    best_key = None
    ...
    for alias in field_aliases:
        ...
        for default_norm, value in defaults_normalized.items():
            ...
            common = alias_words & default_words

            if common:
                # Score: common words / total unique words (Jaccard-like)
                score = len(common) / len(alias_words | default_words)
                if score > best_score:
                    best_score = score
                    best_match = value
                    best_key = default_norm

    # Lowered threshold from 0.5 to 0.2 for better matching
    if best_score >= 0.2:
        logger.debug(f"[SCHEMA_FIELD] Fuzzy match: '{field_name}' -> '{best_key}' (score={best_score:.2f})")
        return best_match

    logger.debug(f"[SCHEMA_FIELD] No field match for: {field_name} (normalized: {field_normalized}, aliases tried: {len(field_aliases)})")
    return None
