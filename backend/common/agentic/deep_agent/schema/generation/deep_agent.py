...
class SchemaGenerationDeepAgent:
    ...
    def generate_schema(self,
        ...
        try:
            ...
            # Record failure
            from common.infrastructure.caching.failure_memory_cache import FailureType
    ...
    def _attempt_recovery(self,
        ...
        try:
            ...
            from common.infrastructure.caching.failure_memory_cache import FailureType, RecoveryAction
