...
from common.infrastructure.caching import (
    SchemaFailureMemory,
    FailureEntry,
    SuccessEntry,
    FailureType,
...
# reset_failure_memory is not exported from caching, but we can import it from failure_memory_cache if needed
from common.infrastructure.caching.failure_memory_cache import reset_failure_memory
