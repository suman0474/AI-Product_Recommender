...
# Import domain classifier for standards document routing
from .domain_classifier import classify_domain, get_routed_documents
...
# REDUCED from 60 to 20: More realistic threshold that reduces unnecessary RAG calls
# while still ensuring adequate spec coverage for most product types.
MIN_STANDARDS_SPECS_COUNT = 60
MAX_SPECS_PER_ITEM = 110  # Safety cap for standards-based enrichment
