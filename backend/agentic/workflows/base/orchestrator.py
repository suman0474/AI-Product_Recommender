...
# default_section captures content before first section marker
...
# Load classification prompts and intent analysis prompts
...
class PromptRegistry:
    ...
    def _initialize_prompts(self):
        ...
        self.register("sales_initial_input", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_yes_additional", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_no_additional", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_acknowledge_additional", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_advanced_yes", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_advanced_no", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_advanced_display", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_final_analysis", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_analysis_error", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_knowledge_question", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        self.register("sales_default", _SALES_AGENT_MAIN_PROMPT, {
            "category": PromptCategory.SALES_AGENT,
        ...
        try:
            _rag_prompts = load_prompt_sections("rag_prompts", default_section="RAG_INTRO")
...
def sales_agent_respond_tool(
    ...
    try:
        ...
        step_prompts = {
            ...
            "initialInput": _SALES_AGENT_MAIN_PROMPT,
            "yesAdditional": _SALES_AGENT_MAIN_PROMPT,
            "noAdditional": _SALES_AGENT_MAIN_PROMPT,
            "acknowledgeAdditional": _SALES_AGENT_MAIN_PROMPT,
            "advancedYes": _SALES_AGENT_MAIN_PROMPT,
            "advancedNo": _SALES_AGENT_MAIN_PROMPT,
            "advancedDisplay": _SALES_AGENT_MAIN_PROMPT,
            "summaryIntro": _SALES_WORKFLOW_PROMPTS["SUMMARY_GENERATION"],
            "summaryProceed": _SALES_WORKFLOW_PROMPTS["SUMMARY_GENERATION"],
            "finalAnalysis": _SALES_AGENT_MAIN_PROMPT,
            "analysisError": _SALES_AGENT_MAIN_PROMPT,
            "knowledgeQuestion": _SALES_AGENT_MAIN_PROMPT,
            "default": _SALES_AGENT_MAIN_PROMPT
        }
        
        prompt = step_prompts.get(step, _SALES_AGENT_MAIN_PROMPT)
