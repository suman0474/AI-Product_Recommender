...
_SHARED_AGENT_PROMPTS = load_prompt_sections("shared_agent_prompts", default_section="QUALITY_ASSURANCE")
_INDEX_RAG_PROMPTS = load_prompt_sections("index_rag_prompts", default_section="INTENT_CLASSIFICATION")

CHAT_AGENT_PROMPT = _INDEX_RAG_PROMPTS["CHAT_AGENT"]
