...
export function ProfileEditDialog({ open, onOpenChange }: ProfileEditDialogProps) {
    ...
    useEffect(() => {
        if (open && user) {
            ...
            setCompanyName(user.companyName || (user as any).company || ""); // Handle both convention cases
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            // Pass plain object instead of FormData, matching the api logic
            await updateProfile({
                            ...
                            <div className="col-span-3 space-y-2">
                                <div className="relative hover:scale-[1.02] transition-all duration-300">
                                    <Input
                                        ...
                                        placeholder="Upload Strategy Document"
                                    />
                                    <Button
                                        type="button"
                                        variant="ghost"
