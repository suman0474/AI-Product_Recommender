                ...
                <div className="space-y-2 animate-item stagger-5">
                  ...
                  <div className="relative hover:scale-[1.02] transition-all duration-300">
                    <div
                      ...
                      className="form-glass-input rounded-xl px-3 py-2 cursor-pointer flex items-center justify-between hover:scale-100"
                    >
                      <span className={standardsFile ? "text-foreground" : "text-muted-foreground"}>
                        {standardsFile ? standardsFile.name : "Upload Standards Document (Optional)"}
                      </span>
                      <FileText className={`h-4 w-4 ${standardsFile ? "text-primary" : "text-muted-foreground"}`} />
                    </div>
                    <Input
                      type="file"
