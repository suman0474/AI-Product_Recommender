...
const DEFAULT_UI_LABELS: UILabels = {
    ...
    inputPlaceholder: "Ask about vendors, products, standards, or specifications...",
    ...
    useEffect(() => {
        ...
        const loadState = async () => {
            ...
            if (urlParams.get('fresh') === 'true') {
                console.log('[CHAT] Fresh navigation detected - clearing all stored state');
                await clearChatDBState();
                        ...
                        <div className="relative group">
                            ...
                            >
                                <textarea
                                    ...
                                    placeholder={isLoading ? "Thinking..." : (uiLabels.inputPlaceholder || "Type your message here...")}
                                    disabled={isLoading}
                                />
